...
class _EcobiciDetail extends State<EcobiciDetail> {
  ...
  Future<void>? fetchData() async {
    ...
    setState(() {
      ...
      lastUpdated =
          DateTime.fromMillisecondsSinceEpoch(stationDetail["last_reported"]);
      loading = false;
    });
  }
                  ...
                  child: Column(mainAxisSize: MainAxisSize.max, children: [
                    Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Container(
                          ...
                          height: 125,
                          child: Image.asset("logoEcobici.png", height: 100))
                    ]),
                    ...
                    Container(
                        ...
                        child: Column(children: [
                          const Text("Datos de la estación",
                              style: TextStyle(
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              Flexible(child: Text(widget.stationName!))
                            ],
                          ),
                          Row(
                            crossAxisAlignment: CrossAxisAlignment.center,
                    ...
                    Container(
                      ...
                      child: Row(children: [
                        Column(
                          ...
                          crossAxisAlignment: CrossAxisAlignment.center,
                          children: [
                            const Text("Docks de Bicicletas",
                                style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  fontSize: 24.0,
                                )),
                            Image.asset("ecobiciStand.png", height: 75.0),
                    ...
                    Container(
                        ...
                        child: Row(children: [
                          Column(
                            ...
                            crossAxisAlignment: CrossAxisAlignment.center,
                            children: [
                              const Text("Bicicletas en la estación",
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 24.0,
                                  )),
                              Image.asset("ecobiciBike.png", height: 75.0),
                              const SizedBox(height: 20),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.center,
                                crossAxisAlignment: CrossAxisAlignment.center,
